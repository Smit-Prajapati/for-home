...
namespace WebAPIInsuranceManagementSystem.Controllers
{
    ...
    public class ClaimController : ControllerBase
    {
        ...
        //public async Task<IActionResult> UpdateClaimStatus(int claimId, [FromBody] int status)
        //{
        //    try
        //    {
        //        if (claimId <= 0)
        ...
        //        await _claimService.UpdateClaimStatus(claimId, status);

        //        return Ok($"Claim status updated successfully to: {status}");
        //    }
        //    catch (Exception ex)
        //    {
